...
# 🎰 CASINO REINVESTMENT PROMOTION BUILDER
# ✅ FINAL STREAMLIT APP (per-country caps + % KPIs + % Pie Charts + FIXED METRICS)
###############################################
...
if uploaded:
    ...
    if st.button("🚀 Generate Promotion Layout"):
        ...
        if df_result is not None:
            ...
            # ✅ FIX: Define columns for metrics
            c1, c2, c3, c4, c5 = st.columns(5)
            c1.metric("💡 Eligible Players", f"{df_result['Eligible_Flag'].sum():,.0f}")
            ...
            st.dataframe(pais_summary, width="stretch")
            ...
            st.dataframe(gest_summary, width="stretch")
